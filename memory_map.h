...
#define CUSTOM_IO_CMD_COMPLETE_TABLE_ADDR   (WAY_PRIORITY_TABLE_ADDR + sizeof(WAY_PRIORITY_TABLE))
#define PERFORMANCE_COUNTER_ADDR        (CUSTOM_IO_CMD_COMPLETE_TABLE_ADDR + sizeof(CUSTOM_IO_CMD_COMPLETE_TABLE))
#define FTL_MANAGEMENT_END_ADDR             ((PERFORMANCE_COUNTER_ADDR + sizeof(PERFORMANCE_COUNTER))- 1)
