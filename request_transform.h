...
#include "nvme/nvme.h"
#include "custom_io_cmd_completion.h"
...
void ReqTransNvmeToSliceCustomCmd(unsigned int cmdSlotTag, unsigned int writeStartLba, unsigned int nlbWrite, unsigned int cmdCode, unsigned int fua, unsigned int readStartLba, unsigned int nlbRead);
...
extern P_CUSTOM_IO_CMD_COMPLETE_TABLE customIoCmdCompleteTablePtr;
